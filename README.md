...
| Column collapse aspect sweep | [`examples/column_collapse`](examples/column_collapse) | Lube/Lajeunesse 2005 via Lagree, Staron & Popinet 2011 | PASS: `a = 2, 3, 6` inside the Lube/Lajeunesse/LSP bands, `a = 0.5, 1` documented as outside-reference shallow-column limitations, and the wrong-physics negative control is rejected. |
